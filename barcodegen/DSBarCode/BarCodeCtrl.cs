...
namespace DSBarCode
{
	public class BarCodeCtrl : System.Windows.Forms.UserControl
	{
		...
		private BarCodeWeight weight = BarCodeWeight.Medium;
		private Font headerFont = new Font("Courier", 8);
		...
		private void panel1_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			...
			if (showFooter)
				e.Graphics.DrawString(str, footerFont, Brushes.Black, footerX, yTop);
		...
		{
            file = "..\\..\\..\\" + code + ".bmp";
			Bitmap bmp = new Bitmap(110, 40, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
